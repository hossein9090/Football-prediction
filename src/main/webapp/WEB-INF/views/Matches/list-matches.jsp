    ...
    <div class="col-md-offset-1 col-md-10">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">List of Matches</div>
            </div>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <c:forEach var="tempMatches" items="${matches}">
                        ...
                        <c:url var="updateLink" value="/Matches/updateForm">
                            <c:param name="matchesId" value="${tempMatches.id}" />
                        </c:url>
                        <c:url var="messageWorker" value="/Matches/messageWorker">
                            <c:param name="matchesId" value="${tempMatches.id}" />
                        </c:url>
...
<%--                                 <a href="${deleteLink}" onclick="if (!(confirm('Are you sure you want to delete this?'))) return false">Delete</a>--%>
                                ...
                                <c:if test="${tempMatches.status!=0}">
                                    <a href="${updateLink}">End Match</a>
                                </c:if>

                                <c:if test="${tempMatches.status==0}">
                                    <a style="color: red" href="">Finished - </a>
                                    <a style="color: red" href="${messageWorker}">msg Worker</a>
                                </c:if>
